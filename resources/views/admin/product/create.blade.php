...
<div class="flex space-x-6">
    ...
    <div class="flex flex-col space-y-1 w-full">
        <label class="font-medium text-sm text-gray-600"
            for="sale">{{ trans('maintenance.admin.product.sale') }}</label>
            <input class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 focus:border-gray-300 focus:outline-none block w-full px-4 py-2.5" type="text" name="sale" id="sale"
            value="{{ isset($formData['model']) ? $formData['model']->sale_price : null }}" required>
    </div>
</div>
<div class="flex space-x-6">
    <div class="flex flex-col space-y-1 w-full">
        <label class="font-medium text-sm text-gray-600" for="purchase">{{ trans('maintenance.admin.product.purchase') }}</label>
        <input class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-0 focus:border-gray-300 focus:outline-none block w-full px-4 py-2.5" type="text" name="purchase" id="purchase"
